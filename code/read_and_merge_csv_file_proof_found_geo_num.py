...
and 5 subplots subplots with min max mean of its features for GEO and NUM domain dataset.
...
merged_data_frame_unique_geo = merged_data_frame_unique[merged_data_frame['BaseFilename'] == 'GEO']
merged_data_frame_unique_num = merged_data_frame_unique[merged_data_frame['BaseFilename'] == 'NUM']
...
categories = ['Initial Clause Count', 'Processed Clause Count', 'Unprocessed Clause Count', 'Factor Count', 'Resolvent Count']
...
# Plot for 'MIN' values
axs[0].bar(r - bar_width/2, min_values_geo, color='#FF8C00', width=bar_width, edgecolor='grey', label='GEO')
axs[0].bar(r + bar_width/2, min_values_num, color='#FF1493', width=bar_width, edgecolor='grey', label='NUM')
axs[0].set_xticks(r)
axs[0].set_xticklabels(categories, rotation=90, ha='center')
axs[0].set_ylabel('Min Value')
axs[0].set_title('Comparison of Min Values for GEO and NUM')
axs[0].legend()

# Plot for 'MAX' values
axs[1].bar(r - bar_width/2, max_values_geo, color='#FF8C00', width=bar_width, edgecolor='grey', label='GEO')
axs[1].bar(r + bar_width/2, max_values_num, color='#FF1493', width=bar_width, edgecolor='grey', label='NUM')
axs[1].set_xticks(r)
axs[1].set_xticklabels(categories, rotation=90, ha='center')
axs[1].set_ylabel('Max Value')
axs[1].set_title('Comparison of Max Values for GEO and NUM')
axs[1].legend()

# Plot for 'MEAN' values
axs[2].bar(r - bar_width/2, mean_values_geo, color='#FF8C00', width=bar_width, edgecolor='grey', label='GEO')
axs[2].bar(r + bar_width/2, mean_values_num, color='#FF1493', width=bar_width, edgecolor='grey', label='NUM')
axs[2].set_xticks(r)
axs[2].set_xticklabels(categories, rotation=90, ha='center')
axs[2].set_ylabel('Mean Value')
axs[2].set_title('Comparison of Mean Values for GEO and NUM')
axs[2].legend()
...
plt.savefig(os.path.join(OUTPUT_DIR, "proof_found_3_subplots_geo_num.pdf"))
# plt.show()
plt.close()
...
colors_num = ['blue', 'red', 'green']

# Plotting each feature with side by side bars
for i, feature in enumerate(grouped_min_geo.index):
    # Plot 'geo' bars
    axes[i].bar(positions - bar_width/2, [grouped_min_geo[feature], grouped_max_geo[feature], grouped_mean_geo[feature]],
                width=bar_width, color=colors_geo, label=['Min Geo', 'Max Geo', 'Mean Geo'])
    # Plot 'num' bars
    axes[i].bar(positions + bar_width/2, [grouped_min_num[feature], grouped_max_num[feature], grouped_mean_num[feature]],
    ...
    axes[i].set_xticklabels(['Min', 'Max', 'Mean'])
...
# Show the plot
plt.savefig(os.path.join(OUTPUT_DIR, "proof_found_5_subplots_geo_num.pdf"))
# plt.show()
...
# Plot for 'MIN' values
axs[0].bar(r - bar_width/2, min_values_geo_log, color='#FF8C00', width=bar_width, edgecolor='grey', label='GEO')
axs[0].bar(r + bar_width/2, min_values_num_log, color='#FF1493', width=bar_width, edgecolor='grey', label='NUM')
axs[0].set_xticks(r)
axs[0].set_xticklabels(categories, rotation=90, ha='center')
axs[0].set_ylabel('Min Value')
axs[0].set_title('Comparison of Min Values for GEO and NUM')
...
# Plot for 'MAX' values
axs[1].bar(r - bar_width/2, max_values_geo_log, color='#FF8C00', width=bar_width, edgecolor='grey', label='GEO')
axs[1].bar(r + bar_width/2, max_values_num_log, color='#FF1493', width=bar_width, edgecolor='grey', label='NUM')
axs[1].set_xticks(r)
axs[1].set_xticklabels(categories, rotation=90, ha='center')
axs[1].set_ylabel('Max Value')
axs[1].set_title('Comparison of Max Values for GEO and NUM')
...
# Plot for 'MEAN' values
axs[2].bar(r - bar_width/2, mean_values_geo_log, color='#FF8C00', width=bar_width, edgecolor='grey', label='GEO')
axs[2].bar(r + bar_width/2, mean_values_num_log, color='#FF1493', width=bar_width, edgecolor='grey', label='NUM')
axs[2].set_xticks(r)
axs[2].set_xticklabels(categories, rotation=90, ha='center')
axs[2].set_ylabel('Mean Value')
axs[2].set_title('Comparison of Mean Values for GEO and NUM')
...
plt.savefig(os.path.join(OUTPUT_DIR, "proof_found_3_subplots_log_geo_num.pdf"))
# plt.show()
plt.close()
...
for i, feature in enumerate(grouped_min_geo_log.index):
    # Plot 'geo' bars
    axes[i].bar(positions - bar_width/2, [grouped_min_geo_log[feature], grouped_max_geo_log[feature], grouped_mean_geo_log[feature]],
                width=bar_width, color=colors_geo, label=['Min Geo', 'Max Geo', 'Mean Geo'])
    # Plot 'num' bars
    axes[i].bar(positions + bar_width/2, [grouped_min_num_log[feature], grouped_max_num_log[feature], grouped_mean_num_log[feature]],
                width=bar_width, color=colors_num, label=['Min Num', 'Max Num', 'Mean Num'])
...
# Show the plot
plt.savefig(os.path.join(OUTPUT_DIR, "proof_found_5_subplots_log_geo_num.pdf"))
# plt.show()
